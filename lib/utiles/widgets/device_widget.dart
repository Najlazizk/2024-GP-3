            ...
            children: [
              ...
              SlidableAction(
                ...
                onPressed: (context) {
                  Get.defaultDialog(
                      title: 'Are You Sure?',
                      content: Text('Remove Device ${widget.deviceData.name} from ${FirebaseDataController.instance.user.value.name} account'),
                      actions: [
                        ElevatedButton(
                          onPressed: () {
                            Get.back();
                        ...
                        ElevatedButton(
                          onPressed: () {
                            FirebaseDataController.instance.removeDeviceFromUser(widget.deviceData.deviceID);
                            Get.back();
                          },
                          style: ElevatedButton.styleFrom(backgroundColor: theme.colorScheme.secondary),
                          child: const Text('   Ok    '),
          ...
          endActionPane: ActionPane(
            ...
            children: [
              SlidableAction(
                ...
                flex: 2,
                onPressed: (context) {
                  Get.defaultDialog(title: 'Are You Sure?', content: Text('Remove Device ${widget.deviceData.name}?'), actions: [
                    ElevatedButton(
                      onPressed: () {
                        Get.back();
                      },
                    ...
                    Padding(
                      ...
                      child: Switch.adaptive(
                        ...
                        onChanged: (value) {
                          ...
                          context.read<TimerProvider>().updateDeviceState(value);
